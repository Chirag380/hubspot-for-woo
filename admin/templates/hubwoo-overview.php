				...
				<div class="hubwoo-db__box-full">
					...
					<div class="hubwoo-db__box-full-content">
						<a id="hubwoo_disconnect_account" href="javascript:void(0);" class="hubwoo-btn--dashboard hubwoo-discon hubwoo-btn--primary">
							<?php esc_html_e( 'Disconnect this Account', 'makewebbetter-hubspot-for-woocommerce' ); ?>           
						</a>			
					</div>
				</div>
			</div>
		...
		<div class="hubwoo-db__row hubwoo-db__row--info">
			...
			<div class="hubwoo-db__box hubwoo-db__box--info">
				<div class="hubwoo-db__box--infoCon">
					...
					<div class="mwb-heb-wlcm__btn-wrap">
						<a target="_blank" href="https://docs.makewebbetter.com/hubspot-integration-for-woocommerce/" class="hubwoo-btn--primary hubwoo-btn--dashboard"><?php esc_html_e( 'View User Guides', 'makewebbetter-hubspot-for-woocommerce' ); ?></a>
					</div>
				</div>
			</div>
		</div>
		<div class="hubwoo-db__row">
			<div class="hubwoo-db__column">
				<div class="hubwoo-db__box-full box-services">
					<div class="hubwoo-db__box-title">
						<h4><?php esc_html_e( 'Need Support or advanced consulting services?', 'makewebbetter-hubspot-for-woocommerce' ); ?></h4>
					</div>
					<div class="hubwoo-db__box-full-content">
						<a target="_blank" href="https://tawk.to/chat/5e2bf07cdaaca76c6fcfca43/default" class="hubwoo-btn--primary hubwoo-btn--dashboard hubwoo-btn--dashboard-chat"><?php esc_html_e( 'Chat with Support', 'makewebbetter-hubspot-for-woocommerce' ); ?></a>
						<a target="_blank" href="https://makewebbetter.com/hubspot-woocommerce-onboarding" class="hubwoo-btn--primary hubwoo-btn--dashboard"><?php esc_html_e( 'View Consulting packages', 'makewebbetter-hubspot-for-woocommerce' ); ?></a>  
					</div>
				</div>
			</div>
		</div>
